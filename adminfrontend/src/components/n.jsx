...
//     return (
//         <div>
//             <nav className='flex items-center justify-between h-20 overflow-hidden bg-transparent rounded shadow-lg'>
//                 <div className='p-4'>
//                     <a href="./admin">
...
//             <div className="flex flex-col min-h-screen antialiased text-gray-800 bg-gray-50">
//                 <div className="flex flex-col w-64 min-h-full bg-white border-r">
...
//                     </div>
//                 </div>
//                 <div className="flex-grow p-4 mb-10 ml-64 mt-14">
